  ...
  <h4 class="py-2"><?= $table_name ?></h4>
    ...
    <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="./index.php"><i class="fa-solid fa-chalkboard-user" data-toggle="tooltip" data-placement="top" title=""></i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="./class-announcements-index.php"><i class="fa-solid fa-bullhorn" data-toggle="tooltip" data-placement="top" title="Class Announcement"></i></a>
            </li>
            <!-- <li class="nav-item">
